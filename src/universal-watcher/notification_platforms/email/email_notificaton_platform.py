...
from notification_platforms.email.models.email_input import EmailInput
from notification_platforms.email.models.email_parameters import (
    EmailParameters,
)
from notification_platforms.email.services.email_service import EmailService
